        ...
        <KeyboardAwareScrollView style={{flex: 1}}>
          <Column flex={1} px={4} mt={8}>
            ...
            <Row
              ...
              mt={vs(15)}>
              <Link
                _text={{color: '#3590D5', fontStyle: 'italic'}}
                onPress={vm.onPressForgetPassword}>
                Forgot Password?
              </Link>
            </Row>
            <ActionButton bold mt={vs(15)} onPress={vm.onPressLogin}>
              LOGIN
            </ActionButton>
            <Row justifyContent={'center'} alignItems={'center'} mt={vs(60)}>
              <Text fontStyle={'italic'} fontSize={'md'} color={'#1E293B'}>
